  ...
  const editor = useEditor({
    extensions: [
      ...
      Placeholder.configure({
        placeholder,
        emptyNodeClass:
          'first:before:text-gray-300 first:before:float-left first:before:content-[attr(data-placeholder)] first:before:pointer-events-none',
      }),
      Link.configure({
        openOnClick: false,
        autolink: true,
    ...
    editorProps: {
      attributes: {
        class: cn(
          className,
          'min-h-[90px] w-full overflow-y-auto border border-gray-500 placeholder:text-gray-400 ' +
